...
```bash
npm install @langchain/langgraph @langchain/community @langchain/core @0byte/stagehand
```
...
```typescript
npm install @langchain/langgraph @langchain/community @langchain/core @langchain/openai @0byte/stagehand
