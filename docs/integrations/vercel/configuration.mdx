...
<Tabs>
	<Tab title="npm">
	```bash
	npm install @0byte/stagehand @browserbasehq/sdk playwright zod
	```
	</Tab>

	<Tab title="pnpm">
	```bash
	pnpm add @0byte/stagehand @browserbasehq/sdk playwright zod
	```
	</Tab>

	<Tab title="yarn">
	```bash
	yarn add @0byte/stagehand @browserbasehq/sdk playwright zod
	```
	</Tab>
</Tabs>
